...
public class MainCliente extends javax.swing.JPanel {
    ...
    public void listarClientes() {
        ...
        if (listarCleintes != null) {
            ...
            for (int i = 0; i < listarCleintes.size(); i++) {
                ob[0] = i + 1;
                ob[1] = listarCleintes.get(i).getTipgasolina();
                ob[2] = listarCleintes.get(i).getCantidad();
                ob[3] = listarCleintes.get(i).getTotal();
                modelo.addRow(ob);
            }
        }
    ...
    private void paintForm() {
        if (jTable1.getSelectedRow() != -1) {
            ...
            txtDniruc.setText(d.getTipgasolina());
            txtNombre.setText(d.getCantidad());
            cbxTipo.setSelectedItem(d.getTotal());
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tip_gaolina");

        jLabel3.setText("Cantidad en Litros:");
        ...
        if (jTable1.getSelectedRowCount() > 0) {
            try {
                ...
                if (JOptionPane.showConfirmDialog(this,
                        "Esta seguro de eliminar este registrtro :" + valor + " ? ",
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        to.setTipgasolina(txtDniruc.getText());
        to.setCantidad(txtNombre.getText());
        to.setTotal(cbxTipo.getSelectedItem() == null ? ""
        ...
        if (fila != -1) {
            try {
                ...
                if (resultado != null) {
                    modelo = (DefaultTableModel) jTable1.getModel();
                    Object nuevo[] = {fila + 1, to.getTipgasolina(), to.getCantidad(),
                        to.getTotal()};
            ...
            try {
                if (JOptionPane.showConfirmDialog(this, "Escelente opcion!", "Mensaje de confirmación", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE) == 0) {
                    if (clienteService.saveEntidad(to) != false) {
                        modelo = (DefaultTableModel) jTable1.getModel();
                        Object nuevo[] = {modelo.getRowCount() + 1, to.getTipgasolina(),
                            to.getCantidad(), to.getTotal()};
                        modelo.addRow(nuevo);
                        resetForm();
                    }
                }
